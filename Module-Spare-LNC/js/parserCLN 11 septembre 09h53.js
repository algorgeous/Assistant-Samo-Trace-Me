...
parserCLN = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c55 = function(obj) { id_obj++; return ["SELECT (COUNT (?sobs"+ old_id_obj + ") AS ?num_sobs"+ old_id_obj +") WHERE \n{ SELECT DISTINCT ?sobs"+ old_id_obj +"\nWHERE \n "+ obj[0] + "\n}", obj[1] ];},
        peg$c56 = "compter",
        ...
        peg$c102 = function(id) { return " rdf:type"+ check_model(id); },
        peg$c103 = "n",
        ...
        peg$c113 = function(id) { 
        	...
        	" ?sobs" + (id_obj+act_requete) +check_model( id ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id) + " . \n } " ; 
        	},
        peg$c114 = function(id) { 
        	cond_push++;	
        	return "?sobs" + (id_obj+act_requete) +check_model( id ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id); 
        	},
        peg$c115 = "valeur",
        ...
        peg$c125 = function(id, val) { 
        							cond_push++;
        							return "FILTER( ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " >= "+ val +" ) \n" +
        							" ?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) ; 
        							},
        ...
        peg$c136 = function(id, val) { 
        							cond_push++;
        							return "FILTER( contains( ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " , "+ val +" ) ) \n" +
        							" ?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) ; 
        							},
        peg$c137 = function(id, val) { 
        							cond_push++;
        							return "FILTER NOT EXISTS { FILTER( ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " >= "+ val +" ) \n" +
        							" ?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " . \n }" ; 
        							},
        ...
        peg$c141 = function(id, val) { 
        							cond_push++;
        							return "FILTER NOT EXISTS { \nFILTER( ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " = "+ val +" ) \n" +
        							" ?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " . \n } " ; 
        							},
        peg$c142 = function(id, val) { 
        							cond_push++;
        							return "FILTER NOT EXISTS { \nFILTER( contains( ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " , "+ val +" ) ) \n" +
        							" ?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+check_generate_id_att_val(id.join("")) + " . \n } " ; 
        							},
    	  ...
    	  /*=================================================*/
    	   /* Code destiné à checker les différents models qui existent */
    		function check_model( model )
    		{
    			...
    			if(model.search('/') != -1){ return " " 
    				+ trace_modelURI.substring(0, trace_modelURI.length -1) + model + ">";}
    			/* Sinon, on renvoie les valeurs par défaut */
    			return " model:"+model;
    		}

    		
    		function check_generate_id_att_val( val )
    		{
    			val_res = val; 
    			if(val_res.search('/') != -1)
    				val_res = val_res.replace('/', '_');
    			if(val_res.search('-' != -1))
    				val_res = val_res.replace('-', '_');
