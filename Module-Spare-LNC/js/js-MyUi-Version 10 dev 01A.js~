...
"#possessAttributValueWordInfEga","#possessAttributValueWordContenantValeur");
...
/* Fonction de mise a jour de la variable trace_modelURI */
 ...
 synchroCLN(document.getElementById("resultLangage").value); 
  ...
  // Initialisation de l'ensemble
	...
	$("#possessAttributValueWordContenantValeur").button();
	$( "#possessAttributValueWordContenantValeur" ).bind("click", function(){ focus_add( " contenant la valeur ", "control_world");  active_next_button( possessAttributValueWord_next );  });
